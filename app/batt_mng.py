...
class DTSDA_Mng(mosaik_api_v3.Simulator):
 ...
 #       if self.redis.esistetag(self.tags['DTmode'][0]) != 0:
            ...
            self.DTmodeSTR = self.tags['DTmode']['value']
#            self.DTmodeSTR = self.tags['DTmode'][1]
        ...
        if self.redis.esistetag('DTmode_set', hmode=True) != 0:
#        if self.redis.esistetag(self.tags['DTmode_set'][0]) != 0:
            ...
            self.DTmode_setSTR = self.tags['DTmode_set']['value']      # non esiste, leggo il valore di default letto dal file config
